...
This study focused on understanding the physical determinants of dam safety hazard in the US. In addition, it aimed to understand the temporal changes in run-off that can affect the dam operations in NC. It was found that volume, storage, drainage area, height and length have a siginificant effect on hazard potential of dams which might be intuitive as failure of larger dams can cause greater damages to life and property. Moreover, it was found that a majority of dams irrespective of their safety hazard, are located in sub-basins witnessing a decereasing trend in annual discharge. While decreasing water availability prevents a dam to operate on its full potential, they also decrease the chances of dam failures due to redcued chances of overtopping. However, one thing to keep in mind is that this project used annual run-off values to perform the trend analysis. Breaking down the analysis to monthly or daily scales could potentially change our understanding of dam overflowing risks due to extreme peak flows during storm events. Similar analyis can be performed for other states as well in order to focus on high risk dams situated in areas with increasing water flows and develop management strategies to prevent dam failures.
